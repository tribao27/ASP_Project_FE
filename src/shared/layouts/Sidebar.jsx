...
export default function Sidebar({
  ...
  return (
    <aside
      className={`${sidebarWidth} bg-white border-r border-black/5 flex flex-col px-3 py-6 fixed h-full left-0 top-0 z-50 select-none overflow-y-auto overflow-x-hidden sidebar-transition ${isMobileMenuOpen ? 'translate-x-0 shadow-2xl !w-[260px]' : '-translate-x-full md:translate-x-0'
        }`}
    >
