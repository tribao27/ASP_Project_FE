...
import { Table, Button, Tag, Tooltip, message, Modal, Empty } from 'antd';
          ...
          <Tooltip title="Giải phóng hoàn toàn tài liệu">
            <motion.button
              ...
              onClick={() => {
                Modal.confirm({
                  title: 'Xóa vĩnh viễn',
                  content: 'Lưu ý: Tệp này sẽ biến mất vĩnh viễn khỏi hệ thống.',
                  okText: 'Đồng ý',
                  okType: 'danger',
                  cancelText: 'Hủy',
                  centered: true,
            ...
            <motion.button
              ...
              onClick={() => {
                Modal.confirm({
                  ...
                  content: 'Hành động này sẽ xóa vĩnh viễn tất cả tệp tin trong thùng rác học tập.',
