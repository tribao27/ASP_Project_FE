...
import { initialDocuments } from '@/features/dashboard/mock/documents.mock.js';
...
const documentService = {
  ...
  /**
   * Mock API: Cập nhật tài liệu (Đổi tên, v.v.)
   */
  updateDocument: async (id, updates) => {
    await delay(300);
    // Khi backend có sẵn: return axiosClient.put(`/documents/${id}`, updates);
